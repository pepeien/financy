    ...
    Item {
        ...
        Item {
            ...
            ScrollView {
                ...
                ListView {
                    readonly property var _accounts: internal.getAccounts(Account.Expense).filter((_) => _.isOwnedBy(_root.user.id) == false)
                    ...
                    delegate: Item {
                        readonly property var _item:  _list._accounts[index]
